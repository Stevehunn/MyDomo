...
public class Mouvement extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonHome.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                Intent i = new Intent(Mouvement.this, MainActivity.class);
                startActivity(i);
                onPause();
            }
        });
        ...
        buttonVersHum.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                Intent i = new Intent(Mouvement.this, Humidite.class);
                startActivity(i);
                onPause();
            }
        });
        ...
        buttonRefresh.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                Mouvement.this.webView.loadUrl("https://thingspeak.com/channels/2102609/charts/5?bgcolor=%23ffffff&color=%23d62020&dynamic=true&results=60&title=Mouvement+-+Salon&type=line");
            }
        });
    }
